...
//    output [95:0] outOperationC, output outValidC
    ...
    assign outValidA = validA | validB;
    assign outValidB = validA ? validB : 1'b0;
    
    assign outOperationA = validA ? inOperationA : inOperationB;
    assign outOperationB = inOperationB;
