...
HD_PWD='C:/Users/Aaron Lo/Documents/FPGA/OutOfOrderProcessor/OutOfOrderProcessor.runs/OOOP_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OOOP_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OOOP_clk_wiz_0.tcl
