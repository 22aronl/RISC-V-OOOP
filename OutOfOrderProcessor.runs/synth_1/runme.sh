...
HD_PWD='C:/Users/Aaron Lo/Documents/FPGA/OutOfOrderProcessor/OutOfOrderProcessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OOOP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OOOP_wrapper.tcl
