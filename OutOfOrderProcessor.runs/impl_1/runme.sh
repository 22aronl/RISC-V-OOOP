...
HD_PWD='C:/Users/Aaron Lo/Documents/FPGA/OutOfOrderProcessor/OutOfOrderProcessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OOOP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OOOP_wrapper.tcl -notrace
