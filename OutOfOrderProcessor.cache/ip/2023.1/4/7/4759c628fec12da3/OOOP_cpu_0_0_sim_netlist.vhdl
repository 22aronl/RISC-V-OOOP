...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display is
  port (
    ...
    \refresh_reg[19]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display is
  signal activate_refresh : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal \refresh_reg[19]_i_1_n_1\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_2\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_3\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_4\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_5\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_6\ : STD_LOGIC;
  signal \refresh_reg[19]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \^seg\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \NLW_refresh_reg[19]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \refresh_reg[19]_i_1\ : label is 11;
...
\refresh_reg[19]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => '1',
      D => \refresh_reg[19]_i_1_n_4\,
      Q => \^seg\(0),
      R => '0'
    );
\refresh_reg[19]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \refresh_reg[12]_i_1_n_0\,
      CO(3) => \NLW_refresh_reg[19]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \refresh_reg[19]_i_1_n_1\,
      CO(1) => \refresh_reg[19]_i_1_n_2\,
      CO(0) => \refresh_reg[19]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \refresh_reg[19]_i_1_n_4\,
      O(2) => \refresh_reg[19]_i_1_n_5\,
      O(1) => \refresh_reg[19]_i_1_n_6\,
      O(0) => \refresh_reg[19]_i_1_n_7\,
      S(3) => \^seg\(0),
      S(2) => activate_refresh(0),
...
\seg[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => activate_refresh(0),
      I1 => \^seg\(0),
      O => \refresh_reg[19]_0\(1)
    );
\seg[2]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => activate_refresh(0),
      I1 => \^seg\(0),
      O => \refresh_reg[19]_0\(0)
    );
\seg[4]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => activate_refresh(0),
      I1 => \^seg\(0),
      O => \refresh_reg[19]_0\(2)
    );
\seg[6]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^seg\(0),
      O => \refresh_reg[19]_0\(3)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cpu is
  port (
    an : out STD_LOGIC_VECTOR ( 3 downto 0 );
    seg : out STD_LOGIC_VECTOR ( 0 to 0 );
    \refresh_reg[19]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC
  );
...
display: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display
     port map (
      ...
      clk => clk,
      \refresh_reg[19]_0\(3 downto 0) => \refresh_reg[19]\(3 downto 0),
      seg(0) => seg(0)
    );
end STRUCTURE;
library IEEE;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cpu
     port map (
      an(3 downto 0) => an(3 downto 0),
      clk => clk,
      \refresh_reg[19]\(3) => \^seg\(6),
      \refresh_reg[19]\(2) => \^seg\(4),
      \refresh_reg[19]\(1) => \^seg\(0),
      \refresh_reg[19]\(0) => \^seg\(2),
      seg(0) => \^seg\(5)
    );
end STRUCTURE;
