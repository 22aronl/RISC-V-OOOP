...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display is
  ...
  signal \display_second_reg_n_0_[0]\ : STD_LOGIC;
  signal \display_second_reg_n_0_[3]\ : STD_LOGIC;
...
\display_second_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => '1',
      Q => \display_second_reg_n_0_[0]\,
      R => '0'
    );
\display_second_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\seg[2]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFB"
        ...
        port map (
      I0 => \display_second_reg_n_0_[3]\,
      I1 => activate_refresh(0),
      I2 => activate_refresh(1),
      I3 => \display_second_reg_n_0_[0]\,
      O => seg(0)
    );
\seg[3]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\seg[5]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
      I0 => \display_second_reg_n_0_[3]\,
      I1 => activate_refresh(1),
      I2 => activate_refresh(0),
      O => seg(3)
    );
\seg[6]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^seg\ : STD_LOGIC_VECTOR ( 6 downto 2 );
